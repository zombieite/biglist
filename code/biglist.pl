...
sub make_docs {
    ...
    # Website header
    my $number_of_best_things = scalar @$addresses;
...
<body>
<h1>WASTELAND FIREBIRD'S BIG LIST OF THE $number_of_best_things BEST THINGS ON ROUTE 66</h1>
...
<h3>Wasteland Firebird's Big List of the Best Things On Route 66 is like no other Route 66 guide. Each page has a QR code that opens up Google Maps directions to your next destination. If you stop at every address, you'll be on Route 66. No app needed! It's all the best things, personally verified twice a year. Many pages contain descriptions, reviews, recommendations, memories of previous journeys, or musings about the American Dream.</h3>
<h3>Wasteland Firebird has traveled the Route five times, obsessively adding and subtracting items from this list along the way. None of the businesses in this book paid to appear in it. This book is solely a list of places that are beautiful, old, quirky, luxurious, or delicious. Every place in this book is worth at least a brief stop. Some of the entries are new discoveries that have never before been seen in connection with Route 66, such as "Room Attack" and "Toynbee Tiles."</h3>
...
<a class="c2" href="https://www.reddit.com/user/WastelandFirebird/">Reddit</a> &middot; 
<a class="c3" href="https://wastelandfirebird.substack.com/">Substack</a> &middot; 
<a class="c4" href="https://www.paypal.com/paypalme/wastelandfirebird">PayPal</a> &middot; 
<a class="c1" href="https://www.patreon.com/c/wastelandfirebird">Patreon</a> &middot; 
<a class="c2" href="https://www.tiktok.com/\@wastelandfirebird">TikTok</a> &middot; 
<a class="c3" href="mailto:wastelandfirebird\@gmail.com">wastelandfirebird\@gmail.com</a> &middot; 
<a class="c4" href=" https://www.lulu.com/shop/john-binns-and-steve-scholz-and-marky-make-up/heads-will-rock/paperback/product-r2vrpv.html?page=1&pageSize=4">Heads Will Rock: A chronicle of postapocalyptic mayhem</a> &middot; 
<a class="c1" href="https://www.instagram.com/p/DY0ZPatE5_l/">Wasteland Firebird's next Route 66 tour dates</a> &middot;
...
|;
    ...
    print $html_forward qq|<hr><h3><span style="color:#000;">Chicago to LA</span> &middot; <a href="backward.html">LA to Chicago</a></h3>|;
    ...
    print $html_backward qq|<hr><h3><a href="/">Chicago to LA</a> &middot; <span style="color:#000;">LA to Chicago</span></h3>|;
...
qq|We can't talk about Joliet Prison without talking about The Blues Brothers. That film is an archive of Americana. The music in that film spanned the entire Twentieth Century. Cab Calloway started making music in 1927, the year Angel Delgadillo was born, and one year after Route 66 came into being. Due to swift advances in music and communication technology, the Twentieth Century spawned a new genre of music every single decade. When was the last time you heard a truly new genre of music?|,
        ...
        },
        {
            ...
            address => "508 Broadway St, Lincoln IL",
            blurb   => qq||,
        },
        {
            name    => "Mill Museum",
...
Buc-ee's is privately held, so they can focus on customer happiness without worrying about short-term shareholder profits.|,
        ...
        },
        {
            ...
            address => "520 S Main St, Galena KS",
...
qq|The current owners took over this place in 1980 and I don't think their prices have changed since. Last time I was here, the lady accidentally charged me \$2.50 for an \$8.50 order. When I pointed out the error, she used a calculator to determine the amount I still had left to pay. But if I'm ever lucky enough to reach her age, I'll be satisfied if I have half of her mental acuity. Her elderly son gets up every day at 3am to run 10 miles, and he rides around in the only car ever offered with a factory flame job: a Chrysler PT Cruiser.|,
        ...
        {
            name    => "Seaba Station",
            address => "336992 OK-66, Warwick OK",
            blurb   => qq||,
        },
        {
