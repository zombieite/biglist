...
<h3>Wasteland Firebird's Big List of the Best Things On Route 66 is like no other Route 66 guide. It's not a map. It's a carefully curated list of addresses, updated twice yearly. It's all the best things, and nothing more. Each page has a QR code that opens up Google Maps directions to your next destination. If you stop at every address, you'll be on Route 66. No app needed! Many pages contain descriptions, reviews, recommendations, memories of previous journeys, or musings about the American Dream.</h3>
