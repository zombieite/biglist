...
<h3>Purchasable physical copies of this list in book form <a href="https://www.lulu.com/account/projects/zmep9ym">are available now!</a></h3>
...
<h3>Wasteland Firebird has traveled the Route five times, adding and subtracting items from this list along the way. None of the businesses in this book paid to appear in it. This book is solely a list of places that are beautiful, quirky, old, luxurious, or delicious. Every page is worth at least a brief stop. Some of the entries are new discoveries that have never before been seen in connection with Route 66, such as "Room Attack" and "Toynbee Tiles."</h3>
